...
//     memberName.innerText = `${member.name} ${member.surname} ${member.age}`;
//     div.appendChild(memberName);
//
//     let inf = document.createElement('p');
//     inf.innerText = `${member.info}`;
//     div.appendChild(inf);
//
...
//     courseduration.innerText = `Duration is ${course.monthDuration} months`;
//     div.appendChild(courseduration);
//
//     let hourly = document.createElement('h4');
//     hourly.innerText = `Hourly duration is ${course.hourDuration} hours`;
//     div.appendChild(hourly);
//
//
//     let listOfModules = document.createElement('ul');
//
//         for (const list of course.modules) {
//
//             let li = document.createElement('li');
//             li.innerText = list;
//            listOfModules.appendChild(li);
//             div.appendChild(listOfModules);
//
//
//         }
//
...
//
// let list2 = document.getElementsByClassName('courses')[0];
...
//     courseName.innerText = `${course.title} - ${course.monthDuration}`;
//     div.appendChild(courseName);
//
...
//     text.innerText = `Duration of this course is ${course.monthDuration}`;
